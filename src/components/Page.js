...
export default function Page(props) {
    ...
    return (
        <>
                ...
                <div className={classes.header}>
                    <Grid container alignItems='center'>
                        <h3 className={classes.name}
                            style={{padding: '25px 0 15px 0'}}>{village.type === 1 ? 'Коттеджный поселок ' + village.name : 'Дачный поселок ' + village.name}</h3>
                    </Grid>
                    <Grid container alignItems='center'>
                        <Grid item xs={12} md={4}>
                            <h4 style={{padding: '10px 0'}}>Участков <span
                                style={{color: '#0197fd'}}>{village.totalLands}</span>
                            </h4>
                            <h4 style={{padding: '10px 0'}}>В продаже <span
                                style={{color: '#0197fd'}}>{village.leftLands}</span></h4>
                        </Grid>
                        <Grid item xs={12} md={4}>
                        ...
                        <Grid item xs={12} md={4}>
                            <h4 style={{padding: '10px 0'}}><span
                                style={{color: '#0197fd'}}>{village.fromMkad}</span> км.
                                от МКАД</h4>
                            <h4 style={{padding: '10px 0'}}>От <span
                                style={{color: '#0197fd'}}>{spaceInNumber(village.price)}</span> руб/сотка
                            </h4>
                        </Grid>
                    </Grid>
                </div>
                ...
                <Grid container>
                    <Grid item xs={12} md={8}>
                        <div style={{
                            ...
                            <Carousel loop auto
                                      widgets={[IndicatorDots, CarouselButtons]}>
                                {slides}
                            </Carousel>
                        </div>
                    </Grid>
            ...
            <Container maxWidth='lg'>
                <h4 style={{padding: '15px 0'}}>Координаты GPS: <span
                    style={{color: '#0197fd'}}>{coords[0]}, {coords[1]}</span></h4>
            </Container>
                        ...
                        <Grid item xs={12} md={4}>
                            <button className='main-button' style={{
                                ...
                                margin: '10px 5%'
                                    ...
                                    onClick={() => {
                                        window.open(rosreestrLink, '_blank')
                                    }}
                            >
                                Кадастровая карта
                            </button>
